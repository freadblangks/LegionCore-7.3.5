...
MySQL - 5.7.44-log : Database - auth
*********************************************************************
*/
...
CREATE TABLE `account` (
  ...
  `referer` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `account_donate_token_log` (
  ...
  `buyType` tinyint(3) unsigned NOT NULL,
  `productId` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `account_donate_token_log` */
...
/*Data for the table `account_tokens` */
